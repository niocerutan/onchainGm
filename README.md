...
Say **Good Morning** on the [Robinhood Chain](https://arc.network). Every GM is stored permanently on-chain — instant finality, near-zero gas (paid in USDC).
...
# Deploy to Robinhood Testnet — you need testnet USDC from faucet.testnet.chain.robinhood.com
...
Open **http://localhost:5173** — connect MetaMask to Robinhood Testnet, click "Say GM"!
...
## Adding MetaMask to Robinhood Testnet

MetaMask won't know about Robinhood Testnet until you add it. Either:
